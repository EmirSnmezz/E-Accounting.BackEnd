...
namespace E_Accounting.BackEnd.UnitTest.Features.AppFeature.CompanyFeatures.UCAFFeatures.Commands
{
    public sealed class CreateUCAFCommandUnitTest
    {
        ...
        {
            UniformChartOfAccount ucaf = await _ucafService.Object.GetByCode(It.IsAny<string>());
            ucaf.ShouldBeNull();    
        }
